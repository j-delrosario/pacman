...
\COPY passenger FROM 'C:\Users\delro\Desktop\CSC343\A2\passenger.csv' DELIMITER ',' CSV header;
\COPY airport FROM 'C:\Users\delro\Desktop\CSC343\A2\airport.csv' DELIMITER ',' CSV header;
\COPY airline FROM 'C:\Users\delro\Desktop\CSC343\A2\airline.csv' DELIMITER ',' CSV header;
\COPY plane FROM 'C:\Users\delro\Desktop\CSC343\A2\plane.csv' DELIMITER ',' CSV header;
\COPY flight FROM 'C:\Users\delro\Desktop\CSC343\A2\flight.csv' DELIMITER ',' CSV header;
\COPY departure FROM 'C:\Users\delro\Desktop\CSC343\A2\departure.csv' DELIMITER ',' CSV header;
\COPY arrival FROM 'C:\Users\delro\Desktop\CSC343\A2\arrival.csv' DELIMITER ',' CSV header;
\COPY booking FROM 'C:\Users\delro\Desktop\CSC343\A2\booking.csv' DELIMITER ',' CSV header;
\COPY price FROM 'C:\Users\delro\Desktop\CSC343\A2\price.csv' DELIMITER ',' CSV header;
\COPY q5_parameters FROM 'C:\Users\delro\Desktop\CSC343\A2\q5_parameters.csv' DELIMITER ',' CSV header;
